...
if [ ${DB_TYPE} = 'Mysql' ];then
   sed -i "s|'sqlite:///'+os.path.join(SQL_PATH,'kamifaka.db')|'mysql+pymysql://${DB_USER}:${DB_PASSWORD}@${DB_HOST}:${DB_PORT}/${DB_DATABASE}\?charset=utf8mb4&serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=true'|g" /usr/src/app/service/api/db.py
